      ...
      <div className="bg-slate-950 text-white py-14 border-b border-slate-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-300 text-xs sm:text-sm mt-3 max-w-2xl leading-relaxed">
            Learn how BhoomiMitra protects your contact credentials, supporting document uploads, and property coordinates with encryption, access controls, and strict confidentiality.
          </p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-10 shadow-xs space-y-8">
          ...
          <section className="space-y-3 pb-6 border-b border-slate-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              ...
              <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <span className="text-slate-600">Encrypted distributed object storage for property media and private supporting files.</span>
              </div>
              <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200">
          ...
          <section className="space-y-3">
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 text-xs space-y-1">
              ...
              <p><strong>Email:</strong> <span className="font-mono text-[#c75e0a]">privacy@bhoomimitra.com</span></p>
