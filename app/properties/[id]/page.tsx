              ...
              {!user && !showProtectedInformation ? (
                ...
                <div className="mt-5 space-y-3">
                  <button
                    type="button"
                    onClick={openInquiry}
                    className="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 px-4 py-3.5 text-xs font-black text-white shadow-sm transition-colors hover:bg-emerald-700"
                  >
