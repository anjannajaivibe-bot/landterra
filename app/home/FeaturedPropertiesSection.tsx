      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Published properties from listed individual, company, or agent sellers with direct contact
          </p>
        </div>
        ...
        <div className="p-10 sm:p-14 text-center bg-gradient-to-b from-[#fffbf5] to-white rounded-3xl border border-dashed border-[#FF9933]/40 space-y-4 max-w-2xl mx-auto">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-slate-500 max-w-md mx-auto leading-relaxed">
              Be the first seller to list your plot, home, or commercial space. BhoomiMitra currently charges ₹0 platform listing fee and 0% platform brokerage.
            </p>
          </div>
          <div className="pt-2">
            <Link
            ...
            >
              <span>Post Your Property Listing — ₹0 Current Platform Listing Fee</span>
