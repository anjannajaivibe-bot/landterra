...
import { MapPin, Search, ShieldCheck, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm border border-slate-300 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-emerald-600 focus:border-emerald-600 bg-white"
          />
        </div>
        <button
          type="button"
      ...
      <div className="relative aspect-16/9 w-full rounded-xl overflow-hidden border border-slate-300 bg-slate-100 shadow-inner">
        ...
        <div className="absolute inset-0 bg-slate-200 flex flex-col items-center justify-center p-6 text-center">
          <div className="w-full h-full rounded-lg bg-emerald-950/5 border border-emerald-900/10 relative overflow-hidden flex items-center justify-center">
            {/* Grid Pattern */}
            <div
            ...
            {approximateLocation && (
              <div className="absolute w-36 h-36 rounded-full bg-emerald-500/20 border-2 border-dashed border-emerald-600 animate-pulse flex items-center justify-center">
                <span className="text-[10px] font-bold text-emerald-800 bg-white/80 px-2 py-0.5 rounded-full shadow-xs">
                  400m Privacy Radius
                </span>
              </div>
            )}
            ...
            <div className="relative z-10 flex flex-col items-center">
              <div className="w-10 h-10 rounded-full bg-emerald-600 text-white flex items-center justify-center shadow-lg border-2 border-white transform -translate-y-2 hover:scale-110 transition-transform">
      ...
      <div className="p-3.5 rounded-xl border border-slate-200 bg-slate-50 flex items-start gap-3">
        <button
          ...
          className={`mt-0.5 w-5 h-5 rounded-md flex items-center justify-center text-white transition-colors ${
            approximateLocation ? 'bg-emerald-600' : 'border border-slate-300 bg-white text-transparent'
          }`}
        >
          ✓
        </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-2">
        <div className="md:col-span-3">
          ...
          <input
            ...
            className="w-full px-3 py-2 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-600 focus:border-emerald-600 bg-white"
            required
          />
        </div>
