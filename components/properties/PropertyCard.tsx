...
export function PropertyCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full md:w-[320px] lg:w-[360px] xl:w-[380px] shrink-0 aspect-[16/10] md:aspect-auto md:self-stretch min-h-[220px] md:min-h-[250px] md:max-h-[340px] bg-slate-100 overflow-hidden">
        <Link
      ...
      <div className="flex flex-1 flex-col justify-between p-4 sm:p-5 min-w-0">
        <div>
          ...
          {/* Title */}
          <h3 className="mt-2.5 text-base sm:text-lg lg:text-xl font-black text-slate-900 leading-snug transition-colors group-hover:text-[#c75e0a] line-clamp-2">
          ...
          <div className="my-2.5 grid grid-cols-2 sm:grid-cols-3 gap-2 rounded-2xl border border-slate-100 bg-slate-50/70 p-2.5">
            <div>
        ...
        <div className="mt-3 flex items-center justify-end">
          <Link
            href={`/properties/${property._id}`}
            prefetch={false}
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#FF9933] px-5 py-2 text-xs sm:text-sm font-black text-white shadow-2xs hover:bg-[#f07d12] hover:shadow-md transition-all cursor-pointer"
          >
